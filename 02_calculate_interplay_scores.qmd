...
def calculate_interplay_scores_optimized(df, tolerance=1e-9):
    ...
    df.loc[mask1, ['interplay', 'abundance_corrected_interplay', 'normalized_interplay']] = [np.nan, np.nan, -1]
...
def process_files(annotation_df, base_dir, input_dir, output_dir):
    ...
    for index, row in annotation_df.iterrows():
        ...
        try:
            ...
            print(f"Columns in {file_name}: {data_df.columns.tolist()}")  # Debugging line

            # Rename 'PTM Combination' to 'binary_comb' for uniformity
...
if __name__ == "__main__":
    ...
    annotation_path = os.path.join(base_dir, 'data', 'experimental_annotation.csv')
